...
export class ProductComponent implements OnInit {
    ...
    private columnConfigData(): IMatTableColumnConfig[] {
        return [
            ...
            { columnId: 'direction', columnName: 'Direction', visible: false },
            { columnId: 'full_name', columnName: 'Full Name', visible: true },
            { columnId: 'display_name', columnName: 'Display Name', visible: true },
            { columnId: 'description', columnName: 'Description', visible: true },
            ...
            { columnId: 'is_variable', columnName: 'Is Variable', visible: true },
